//! Resilient provider wrapper with retry, fallback, and model failover.
//!
...
fn sanitize_api_error(input: &str) -> String {
    ...
    for prefix in PREFIXES {
        ...
        loop {
            ...
            // Find end of token (alphanumeric + common secret chars)
...
mod tests {
    ...
    // ── Rate limit Retry-After edge cases ──

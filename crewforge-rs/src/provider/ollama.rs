...
impl OllamaProvider {
    ...
    /// Convert Ollama tool calls to the JSON format expected by the agent loop.
...
impl Provider for OllamaProvider {
    ...
    async fn chat_with_system(
        ...
        // If model returned tool calls, format them for the agent loop parser
...
mod tests {
    ...
    #[test]
    fn capabilities_include_native_tools_but_not_vision() {
        let provider = OllamaProvider::new(None, None);
